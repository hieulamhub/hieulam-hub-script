...
v0.new("<Color=Cyan>Welcome to hieulam Hub<Color=/>"):Display();
wait(0.5);
...
v5.Window = function(v134, v135)
	...
	v170.Image = "http://www.roblox.com/asset/?id="   .. tostring(130101038916267) ;
...
v8.Image = "rbxassetid://130101038916267";
v8.Draggable = true;
...
game:GetService("StarterGui"):SetCore("SendNotification", {
	...
	Text = "Loading...",
	Icon = "rbxthumb://type=Asset&id=130101038916267&w=150&h=150",
	Duration = 10
});
spawn(function()
	while wait() do
